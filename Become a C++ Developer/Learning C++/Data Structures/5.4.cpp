//pointers.We need ptrs to dynamic alocate memory
#include <iostream>
using namespace std;
...
int main()
{
	/*
	int JohnsAcct = 12345;
	int *acctPtr = &JohnsAcct; //declare ptr

	cout << "John acct number: " << JohnsAcct << " is at: "
			<< acctPtr << endl;
	cout << "acctPtr point to this value: *acctPtr:" << *acctPtr << endl;
	...
	*numPtr += 5; //num value is now 100
	...
	cout << endl << "Next example, using charatcters" << endl;
	char letter = 'A';
